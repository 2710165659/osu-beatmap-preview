...
> **⚠️ 此 Python 版本已不再更新，仅供参考。** 最新功能与效果请以 *Rust 版本* 为准。
...
安装后可使用 `osu-preview` 命令：

```bash
osu-preview --bid=123456
```

或者直接运行入口脚本：

```bash
python run.py --bid=123456
```
...
python run.py --bid=123456 --convert=mania

# 强制输出 GIF
python run.py --bid=123456 --convert=mania --fmt=gif

# 添加 mod
python run.py --bid=123456 --mods=hd+hr

# 自定义倍速
python run.py --bid=123456 --mods=dt1.25

# 自定义时间点
python run.py --bid=123456 --time=10+25+60

# standard 的 DA
python run.py --bid=123456 --mods=dacs5ar9.5

# 较复杂的组合示例
python run.py --bid=123456 --convert=mania --fmt=gif --mods=4k+ds+in+dt1.2 --time=10+30+50
```
