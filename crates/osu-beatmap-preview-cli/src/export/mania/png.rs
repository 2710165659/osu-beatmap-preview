...
use osu_beatmap_preview_core::domain::models::{Beatmap, ManiaHitObject, TimingPoint};
...
fn calculate_column_count(beatmap_duration: i64, total_chart_height: i64) -> Result<i64> {
    ...
    {
        return Err(
            osu_beatmap_preview_core::domain::errors::PreviewError::render(
...
fn draw_column_background(
    ...
    for lane_index in 0..key_count as i64 {
        ...
        if lane_index > 0 {
            let separator_width = crate::export::geometry::scale_stroke_px(
                1.0,
...
fn draw_timing_line(
    ...
    let line_height = crate::export::geometry::scale_stroke_px(
        1.0,
        crate::export::geometry::output_scale(
            crate::export::geometry::GameMode::Mania,
            crate::export::geometry::OutputFormat::Png,
    ...
    if timing_line.show_label {
        ...
        let text_gap = crate::export::geometry::scale_px(
            4.0,
            crate::export::geometry::output_scale(
                crate::export::geometry::GameMode::Mania,
                crate::export::geometry::OutputFormat::Png,
        ...
        if let Some(ref bpm_label) = timing_line.bpm_label {
            ...
            let bpm_gap = crate::export::geometry::scale_px(
                3.0,
                crate::export::geometry::output_scale(
                    crate::export::geometry::GameMode::Mania,
                    crate::export::geometry::OutputFormat::Png,
