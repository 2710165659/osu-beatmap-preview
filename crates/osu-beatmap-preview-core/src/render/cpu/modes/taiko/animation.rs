...
/// 连打点成功判定后的缩放与淡出时长。
pub const DRUM_ROLL_TICK_FADE_MS: f64 = 200.0;
/// 小节线越过判定位置后的淡出时长。
pub const MEASURE_LINE_FADE_MS: f64 = 150.0;

#[derive(Debug, Clone, Copy, PartialEq)]
pub struct DrumRollTick {
    pub time: f64,
}
...
pub fn generate_drum_roll_ticks(
...
pub fn drum_roll_tick_transform(tick_time: f64, snapshot_time: i64) -> (f64, f64) {
...
pub fn measure_line_alpha(line_time: f64, snapshot_time: i64) -> f64 {
