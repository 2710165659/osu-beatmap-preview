...
pub fn normal_object_alpha(
    ...
    (1.0 - (snapshot_time - end_time) as f64
        / crate::render::cpu::modes::standard::constants::SLIDER_FADE_OUT_MS as f64)
        .max(0.0)
}

pub fn hidden_object_alpha(
    start_time: i64,
    end_time: i64,
    snapshot_time: i64,
    settings: &RenderSettings,
...
pub fn hidden_slider_body_alpha(
    start_time: i64,
    end_time: i64,
    snapshot_time: i64,
    settings: &RenderSettings,
        ...
        <= hit_object.start_time + crate::render::cpu::modes::standard::constants::POST_HIT_FADE_MS
    {
        return 1.0
            - (snapshot_time - hit_object.start_time) as f64
                / crate::render::cpu::modes::standard::constants::POST_HIT_FADE_MS as f64;
    }
    0.0
}
...
pub fn slider_path_progress(span_count: i64, completion: f64) -> f64 {
