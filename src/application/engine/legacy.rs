...
static CONVERTERS: &[(i32, ConvertFn)] = &[
    (1, crate::domain::rulesets::taiko::taiko_convert),
    (2, crate::domain::rulesets::catch::catch_convert),
    ...
    for point in points {
        let absolute = match point {
            ...
            TimePoint::Seconds(seconds) => {
                ...
                let milliseconds = crate::domain::parser::round_half_even(milliseconds_f64);
...
mod tests {
    use super::*;
    use crate::domain::models::ManiaHitObject;
