...
fn pixels_per_ms_for_ar(approach_rate: f64, playfield_scale: f64) -> f64 {
    ...
    let visible_fall_height = (crate::render::modes::catch::constants::STABLE_CATCHER_Y
        - crate::render::modes::catch::constants::STABLE_FRUIT_START_Y)
        * playfield_scale;
...
fn build_layout(
    ...
    let visible_playfield_width = crate::render::geometry::scale_px(
        crate::render::modes::catch::constants::PLAYFIELD_DISPLAY_WIDTH as f64,
        render_scale,
    );
    let playfield_scale =
        visible_playfield_width as f64 / crate::render::modes::catch::constants::PLAYFIELD_WIDTH;
...
mod tests {
    ...
    fn edge_fruit(x: f64, time: i64) -> RenderObject {
        RenderObject {
            ...
            x,
            start_time: time,
            color: crate::render::modes::catch::constants::LAZER_COMBO_COLORS[0],
            scale_factor: 1.0,
    ...
    fn banana_route_draws_catcher_center_instead_of_banana_centers() {
        ...
        assert_eq!(
            ...
            crate::render::modes::catch::constants::BANANA_ROUTE_LINE_COLOR
        );
        assert_eq!(
