...
pub(crate) struct AnimationLayout {
    ...
    pub(crate) note_side_padding: i64,
    pub(crate) sv_info_margin_left: i64,
...
pub(crate) fn build_layout(
    ...
    let left_panel_width = crate::render::geometry::scale_px(
        crate::render::geometry::scale_px(
            crate::render::modes::mania::constants::LEFT_PANEL_WIDTH as f64,
            0.5,
        ) as f64,
        render_scale,
    );
    let note_side_padding = crate::render::geometry::scale_px(
        crate::render::geometry::scale_px(
            crate::render::modes::mania::constants::NOTE_SIDE_PADDING as f64,
            0.5,
        ) as f64,
        render_scale,
    );
    ...
    let scroll_length = (hit_position_y
        - crate::render::geometry::scale_px(
            crate::render::geometry::scale_px(
                crate::render::modes::mania::constants::STAGE_TOP_PADDING as f64,
                0.5,
            ) as f64,
            render_scale,
        ))
    ...
    let note_head_height = round_half_even(
        crate::render::modes::mania::constants::NOTE_HEAD_HEIGHT as f64 * average_column_width
            / crate::render::modes::mania::constants::LANE_WIDTH as f64,
    )
    .max(1);
    let (
        image_width,
...
pub(crate) fn compute_time_range(
    ...
    let hit_position_scale = (crate::render::modes::mania::constants::FRAME_HEIGHT as f64
        - hit_position)
        / (crate::render::modes::mania::constants::FRAME_HEIGHT as f64
            - crate::render::modes::mania::constants::DEFAULT_HIT_POSITION_FROM_BOTTOM);
    (crate::render::modes::mania::constants::BASE_TIME_RANGE_MS / scroll_speed
        * hit_position_scale
        * speed_multiplier)
        .max(1.0)
}
...
pub(crate) fn segment_left(segment_index: i64, layout: &AnimationLayout) -> i64 {
...
pub(crate) fn draw_segment_background(canvas: &mut Img, seg_left: i64, layout: &AnimationLayout) {
...
mod tests {
    ...
    fn all_mania_keycounts_keep_lane_centers_across_output_scales() {
        for keys in 1..=18 {
            let skin = crate::render::modes::mania::skin::load_mania_skin_config(
                keys,
                crate::render::geometry::OutputFormat::Gif,
            );
