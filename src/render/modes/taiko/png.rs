...
use crate::domain::models::{Beatmap, TaikoHitObject};
...
pub(crate) fn render_taiko_grid(
    ...
    let chart_start_time = crate::domain::shared::time_selection::snap_to_beat_grid(
        first_note_time,
    ...
    let timing_lines = build_timing_lines(
        &redline_sections,
        &mapper,
        crate::render::modes::taiko::constants::MIN_BEAT_LINE_SPACING * render_scale,
        &kiai_sections,
        first_note_time,
...
fn build_png_layout(
    ...
    let normal_note_diameter = pyround(
        crate::infrastructure::config::current()
            ...
            .sizing
            .ROW_HEIGHT as f64
            * crate::render::modes::taiko::constants::NORMAL_NOTE_SIZE_RATIO,
    );
    ...
    fn row_break_measure_anchors_are_scale_invariant_for_all_bpm_tiers() {
        ...
        for multiplier in [1.0, 1.15, 1.3, 1.45] {
            ...
            let baseline = compute_row_start_positions(
                &logical_measures,
                logical_chart_width,
                crate::domain::parser::round_half_even(logical_row_width),
            );
            ...
            for scale in [0.5, 1.0, 1.5, 2.0] {
                ...
                let starts = compute_row_start_positions(
                    ...
                    crate::domain::parser::round_half_even(logical_row_width * scale),
                );
