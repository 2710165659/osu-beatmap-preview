...
pub(crate) struct PreparedTaikoHitObject {
    pub(crate) hit_object: TaikoHitObject,
    pub(crate) start_multiplier: f64,
    pub(crate) end_multiplier: f64,
    pub(crate) min_multiplier: f64,
    pub(crate) max_multiplier: f64,
    pub(crate) drum_roll_ticks: Vec<PreparedAnimationPoint>,
}
...
pub(crate) struct AnimationLayout {
    ...
    pub(crate) first_row_top: i64,
    pub(crate) row_stride: i64,
    pub(crate) render_scale: f64,
    pub(crate) track_background_color: [u8; 4],
    pub(crate) track_edge_color: [u8; 4],
    pub(crate) track_accent_color: [u8; 4],
    pub(crate) judgement_line_color: [u8; 4],
}
...
pub(crate) fn gif_row_top(row_index: i64, layout: &AnimationLayout) -> i64 {
    layout.first_row_top + row_index * layout.row_stride
}

pub(crate) fn gif_row_center_y(row_index: i64, layout: &AnimationLayout) -> i64 {
    gif_row_top(row_index, layout) + layout.row_height / 2
}

pub(crate) fn judgement_line_x(layout: &AnimationLayout) -> i64 {
