...
fn draw_spinner(
    ...
    let center = to_frame_point(
        crate::render::cpu::modes::standard::constants::PLAYFIELD_WIDTH / 2.0,
        crate::render::cpu::modes::standard::constants::PLAYFIELD_HEIGHT / 2.0,
    ...
    let pink = crate::render::cpu::modes::standard::constants::ARGON_SPINNER_PINK;
...
fn build_circle_piece(diameter: i64, color: [u8; 3]) -> Img {
    ...
    let c = d as f64 / 2.0;
    let border = d as f64 * crate::render::cpu::modes::standard::constants::ARGON_BORDER_RATIO;
...
fn draw_break_overlay(
    ...
    let (_, counter_h) = crate::render::text::text_size(
        ...
        crate::render::text::scaled_bitmap_font_height(
            crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_COUNTER_FONT_SIZE,
            render_scale,
        ),
    );
    let counter_y =
        py_round(center_y - crate::render::geometry::scale_px(15.0, render_scale) as f64)
            - counter_h as i64;
    let counter_color = [
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_COLOR[0],
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_COLOR[1],
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_COLOR[2],
        py_round(
            crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_COLOR[3] as f64 * alpha,
        )
        .clamp(0, 255) as u8,
    ];
    draw_centered_text(
    ...
    let info_y = py_round(center_y)
        + crate::render::geometry::scale_px(
            crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_TOP_GAP as f64,
            render_scale,
        );
    let info_color = [
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_COLOR[0],
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_COLOR[1],
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_COLOR[2],
        py_round(
            crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_COLOR[3] as f64
                * alpha,
        )
        .clamp(0, 255) as u8,
    ];
    draw_centered_text(
        ...
        info_y,
        crate::render::text::scaled_bitmap_font_height(
            crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_INFO_FONT_SIZE,
            render_scale,
        ),
        info_color,
        context.frame_layout.frame_width,
...
fn draw_break_remaining_bar(
    ...
    let track_width = py_round(
        layer.w as f64
            * crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_BAR_WIDTH_RATIO,
    ) as f64;
    let track_height =
        crate::render::cpu::modes::standard::constants::BREAK_OVERLAY_BAR_HEIGHT * render_scale;
...
fn break_overlay_alpha(break_period: &BreakPeriod, snapshot_time: i64) -> f64 {
    if break_period.end_time - break_period.start_time
        < crate::render::cpu::modes::standard::constants::BREAK_MIN_DURATION_MS
    {
        return 0.0;
    }
    ...
    if snapshot_time
        < break_period.start_time
            + crate::render::cpu::modes::standard::constants::BREAK_FADE_DURATION_MS
    {
        return (snapshot_time - break_period.start_time) as f64
            / crate::render::cpu::modes::standard::constants::BREAK_FADE_DURATION_MS as f64;
    }
    if snapshot_time
